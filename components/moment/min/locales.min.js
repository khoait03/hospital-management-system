!(function (e, a) {
    ...
    function _e(e, a, _) {
        return (
            e +
            " " +
            ((_ = { mm: "munutenn", MM: "miz", dd: "devezh" }[_]),
            2 !== (e = e)
                ? _
                : void 0 !== (e = { m: "v", b: "v", d: "z" })[(_ = _).charAt(0)]
                ? e[_.charAt(0)] + _.substring(1)
                : _)
        );
    }
    e.defineLocale("bo", {
    ...
    var we = {
        ...
        ge =
            (e.defineLocale("kk", {
                ...
                ordinal: function (e) {
                    return (
                        e + (we[e] || we[e % 10] || we[100 <= e ? 100 : null])
                    );
                },
                week: { dow: 1, doy: 7 },
            }),
    ...
    e.defineLocale("ky", {
        ...
        e.defineLocale("lb", {
            ...
            relativeTime: {
                future: function (e) {
                    return We(e.substr(0, e.indexOf(" ")))
                        ? "a " + e
                        : "an " + e;
                },
                past: function (e) {
        ...
        translate: function (e, a, _) {
            ...
            return 1 === _.length
                ? a
                    ? s[0]
                    : s[1]
                : e + " " + w.correctGrammaticalCase(e, s);
        },
    };
    function g(e, a, _, s) {
        switch (_) {
    ...
    (m = [
        ...
        (m = "jan_feb_mar_apr_m\xe1j_j\xfan_j\xfal_aug_sep_okt_nov_dec".split(
            "_"
        ));
    function sa(e) {
        return 1 < e && e < 5;
    ...
    function j(e, a, _, s) {
        ...
        switch (_) {
            ...
            case "ss":
                return a || s
                    ? d + (sa(e) ? "sekundy" : "sek\xfand")
                    : d + "sekundami";
            case "m":
                return a ? "min\xfata" : s ? "min\xfatu" : "min\xfatou";
            case "mm":
                return a || s
                    ? d + (sa(e) ? "min\xfaty" : "min\xfat")
                    : d + "min\xfatami";
            case "h":
                return a ? "hodina" : s ? "hodinu" : "hodinou";
            case "hh":
                return a || s
                    ? d + (sa(e) ? "hodiny" : "hod\xedn")
                    : d + "hodinami";
            case "d":
                return a || s ? "de\u0148" : "d\u0148om";
            case "dd":
    ...
    var P = {
            ...
            translate: function (e, a, _, s) {
                ...
                return 1 === _.length
                    ? "y" === _ && a
                        ...
                        ? d[0]
                        : d[1]
                    : ((s = P.correctGrammaticalCase(e, d)),
                      "yy" === _ &&
                      a &&
                      "\u0433\u043e\u0434\u0438\u043d\u0443" === s
                          ? e + " \u0433\u043e\u0434\u0438\u043d\u0430"
                ...
                translate: function (e, a, _, s) {
                    ...
                    return 1 === _.length
                        ? "y" === _ && a
                            ...
                            ? d[0]
                            : d[1]
                        : ((s = W.correctGrammaticalCase(e, d)),
                          "yy" === _ && a && "godinu" === s
                              ? e + " godina"
                              : e + " " + s);
                },
        ...
        ra =
            (e.defineLocale("tg", {
                ...
                ordinal: function (e) {
                    return (
                        e + (na[e] || na[e % 10] || na[100 <= e ? 100 : null])
                    );
                },
                week: { dow: 1, doy: 7 },
            }),
