...
(function (e) {
                                    ...
                                    step: function (e, i) {
                                        (i.now = Math.round(e)),
                                            "height" !== i.prop
                                                ...
                                                : "content" !== o.options.heightStyle && ((i.now = Math.round(s - t.outerHeight() - r)), (r = 0));
                                    },
                                }),
                                void 0)
        ...
        e.widget("ui.menu", {
            ...
            blur: function (e, t) {
                t || clearTimeout(this.timer),
                    this.active && (this.active.removeClass("ui-state-focus"), (this.active = null), this._trigger("blur", e, { item: this.active }));
            },
                    ...
                    : "radio" === this.type
                        ...
                        : (this.buttonElement
                            ...
                            .bind("keydown" + this.eventNamespace, function (t) {
                                return i.disabled
                                    ? !1
                                    : ((t.keyCode === e.ui.keyCode.SPACE || t.keyCode === e.ui.keyCode.ENTER) && e(this).addClass("ui-state-active"), void 0);
                            })
    ...
    e.extend(n.prototype, {
            ...
            !o ||
                ...
                (this._datepickerShowing &&
                    ((i = this._get(o, "showAnim")),
                        ...
                        this._inDialog &&
                        (this._dialogInput.css({ position: "absolute", left: "0", top: "-100px" }), e.blockUI && (e.unblockUI(), e("body").append(this.dpDiv))),
                        (this._inDialog = !1)));
        },
        ...
        _selectDate: function (t, i) {
            ...
            (i = null != i ? i : this._formatDate(a)),
                ...
                a.inline
                    ...
                    : (this._hideDatepicker(), (this._lastInput = a.input[0]), "object" != typeof a.input[0] && a.input.focus(), (this._lastInput = null));
        },
        ...
        _generateHTML: function (e) {
            ...
            if ((0 > Z && ((Z += 12), et--), $))
                for (
                    t = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - K[0] * K[1] + 1, $.getDate())), t = X && X > t ? X : t;
            ...
            _mouseCapture: function (t) {
                ...
                return (
                    ...
                    this.helper || i.disabled || e(t.target).closest(".ui-resizable-handle").length > 0
                        ? !1
                        : ((this.handle = this._getHandle(t)), this.handle ? (this._blockFrames(i.iframeFix === !0 ? "iframe" : i.iframeFix), !0) : !1)
                );
            },
        ...
        e.widget("ui.resizable", e.ui.mouse, {
            ...
            _create: function () {
                ...
                if (
                    ...
                    for (
                        "all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), t = this.handles.split(","), this.handles = {}, i = 0;
                        t.length > i;
                        i++
                    )
                        (s = e.trim(t[i])),
                ...
                return (
                    ...
                    (i(this.element),
                        ...
                        this.originalElement
                            .css({ position: t.css("position"), width: t.outerWidth(), height: t.outerHeight(), top: t.css("top"), left: t.css("left") })
                            .insertAfter(t),
                        t.remove()),
    ...
    (e.effects = { effect: {} }),
        ...
        (e.effects.effect.size = function (t, i) {
            ...
            "show" === p && o.show(),
                ...
                ("box" === m || "both" === m) &&
                (a.from.y !== a.to.y &&
                    ((y = y.concat(d)), (o.from = e.effects.setTransition(o, d, a.from.y, o.from)), (o.to = e.effects.setTransition(o, d, a.to.y, o.to))),
                    a.from.x !== a.to.x &&
                    ((y = y.concat(c)), (o.from = e.effects.setTransition(o, c, a.from.x, o.from)), (o.to = e.effects.setTransition(o, c, a.to.x, o.to)))),
                ("content" === m || "both" === m) &&
                a.from.y !== a.to.y &&
        ...
        e.widget("ui.selectmenu", {
            ...
            open: function (e) {
                this.options.disabled ||
                    (this.menuItems
                        ? (this.menu.find(".ui-state-focus").removeClass("ui-state-focus"), this.menuInstance.focus(null, this._getSelectedItem()))
                        : this._refreshMenu(),
                        (this.isOpen = !0),
                        this._toggleAttr(),
                        this._resizeMenu(),
        ...
        e.widget("ui.slider", e.ui.mouse, {
            ...
            _start: function (e, t) {
                ...
                return (
                    this.options.values && this.options.values.length && ((i.value = this.values(t)), (i.values = this.values())), this._trigger("start", e, i)
                );
            },
                ...
                keydown: function (t) {
                    ...
                    switch (t.keyCode) {
                        ...
                        case e.ui.keyCode.LEFT:
                            if (
                                (t.preventDefault(),
                                    !this._keySliding && ((this._keySliding = !0), e(t.target).addClass("ui-state-active"), (i = this._start(t, o)), i === !1))
                            )
                                return;
                    }
        ...
        e.widget("ui.sortable", e.ui.mouse, {
                    ...
                    for (i = c.length - 1; i >= 0; i--)
                        for (n = e(c[i], this.document[0]), s = n.length - 1; s >= 0; s--)
                            (a = e.data(n[s], this.widgetFullName)),
                                ...
                                !a.options.disabled &&
                                (d.push([
                                    e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, { item: this.currentItem }) : e(a.options.items, a.element),
                                    a,
                                ]),
                        ...
                        for (
                            ...
                            e.contains(this.containers[p].element[0], this.items[s].item[0]) &&
                                ...
                                ((h = this.items[s].item.offset()[o]),
                                    ...
                                    n > Math.abs(t[d] - h) && ((n = Math.abs(t[d] - h)), (a = this.items[s]), (this.direction = l ? "up" : "down")));
                        if (!a && !this.options.dropOnEmpty) return;
                        if (this.currentContainer === this.containers[p])
                            return (
                                this.currentContainer.containerCache.over ||
                                (this.containers[p]._trigger("over", t, this._uiHash()), (this.currentContainer.containerCache.over = 1)),
                                void 0
                            );
            ...
            _convertPositionTo: function (t, i) {
                ...
                var s = "absolute" === t ? 1 : -1,
                    n =
                        "absolute" !== this.cssPosition || (this.scrollParent[0] !== this.document[0] && e.contains(this.scrollParent[0], this.offsetParent[0]))
                            ? this.scrollParent
                            : this.offsetParent,
        ...
        e.widget("ui.spinner", {
            ...
            _setOption: function (e, t) {
                ...
                ("max" === e || "min" === e || "step" === e) && "string" == typeof t && (t = this._parse(t)),
                    ...
                    this._super(e, t),
                    "disabled" === e &&
                    (this.widget().toggleClass("ui-state-disabled", !!t), this.element.prop("disabled", !!t), this.buttons.button(t ? "disable" : "enable"));
            },
        ...
        e.widget("ui.tooltip", {
            ...
            _tooltip: function (t) {
                ...
                return (
                    e("<div>").addClass("ui-tooltip-content").appendTo(i), i.appendTo(this.document[0].body), (this.tooltips[s] = { element: t, tooltip: i })
                );
            },
            _find: function (e) {
